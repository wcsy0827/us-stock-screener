...
<div class="info-grid">
  ...
  <div class="info-card">
    ...
    <div class="pipe-flow">
      ...
      <div class="pipe-step"><span class="pipe-badge">L1</span>硬條件篩選：股價 &gt; $5、30 日均量 &gt; 50 萬、市值 &gt; 3 億；財報防禦牆：排除 3 天內有財報的個股</div>
      <div class="pipe-arrow">↓</div>
      <div class="pipe-step"><span class="pipe-badge">L2</span>技術評分 100 分制，門檻 60 分；恐慌超跌環境（見右側）降至 40 分，RSI &lt; 35 且 20 日跌幅 &gt; 15% 的超賣股強制放行</div>
      <div class="pipe-arrow">↓</div>
      <div class="pipe-step"><span class="pipe-badge">L3</span>DeepSeek AI 依當日大盤環境（Regime）的主推策略精選，最多 5 支；輸入矩陣含 ATR 標準化動能（Momentum_ATR）、量能推進因子（VTF_Score，正值=帶量上攻，負值=高檔出貨）、60 日 Beta 與財報剩餘天數（≤3 天自動排除），跨行業公平評比、避免高 Beta 偏見；陰跌熊市環境下全面防禦，不輸出任何建議（詳見右側 Regime 表）</div>
    </div>
  </div>
  ...
  <div class="info-card">
    ...
    <table class="info-table">
      ...
      <tr><td>RSI 健康區間</td><td>20</td><td>50～70 滿分；40～50 或 70～80 半分；其餘 0；RSI&gt;80 超買直接排除（全維度歸零）</td></tr>
      <tr><td>MACD 柱狀體</td><td>20</td><td>正且遞增滿分；正遞減半分；負 0</td></tr>
      <tr><td>量能放大</td><td>20</td><td>≥ 1.5x 均量且收盤位於振幅上 60% 以上（多頭推進量）滿分；≥ 1.0x 半分；出貨型爆量（收盤偏低）歸零</td></tr>
      <tr><td>20 日動能</td><td>15</td><td>ATR 倍數法：≥ 2.0 ATR 滿分；≥ 1.0 ATR 半分；&gt;0 為 1/4 分（跨行業公平評比）</td></tr>
    </table>
  </div>
