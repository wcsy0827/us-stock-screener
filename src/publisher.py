...
<div class="info-grid">
  ...
  <div class="info-card">
    ...
    <div class="pipe-flow">
      ...
      <div class="pipe-arrow">↓</div>
      <div class="pipe-step"><span class="pipe-badge">L3</span>DeepSeek AI 依當日大盤環境（Regime）的主推策略精選，最多 5 支；輸入矩陣含 ATR 標準化動能（Momentum_ATR）、量能推進因子（VTF_Score，正值=帶量上攻，負值=高檔出貨）、60 日 Beta 與財報剩餘天數（≤5 天自動排除），跨行業公平評比、避免高 Beta 偏見；並疊加基本面維度（估值 Fwd_PE、獲利品質 Profit_Margin、成長性 Rev_Growth_YoY）輔助取捨，技術面相近時優先選基本面健康的個股；陰跌熊市環境下全面防禦，不輸出任何建議（詳見右側 Regime 表）</div>
    </div>
  </div>
