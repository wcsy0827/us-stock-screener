...
動能策略（momentum）：
- 操作方式：追漲，突破後買進
- 買入區間：當前股價附近，確認突破前高後買進
- 目標價：當前股價 +10%~20%
- 止損：跌破 EMA20 以下
- 持有週期：1～4週
- 適用：均線多頭排列、RSI 50~70、量能持續放大
...
- 止損：跌破近期最低點
- 持有週期：1～6個月
- 適用：基本面穩健、技術面出現支撐、股價處於低估區

突破策略（breakout）：
- 操作方式：突破當日買進
- 買入區間：突破點附近，當日收盤價前後 1%
- 目標價：當前股價 +10%~20%
- 止損：跌回突破點下方 2%
- 持有週期：1～2週
- 適用：量能明顯放大（volume_ratio >= 2）、突破整理區間或前高

反轉策略（oversold_reversal）：
- 操作方式：超賣後反彈確認買進
- 買入區間：確認反彈訊號後，當日或次日開盤買進
- 目標價：當前股價 +8%~15%
- 止損：跌破前低
- 持有週期：1～3週
- 適用：RSI 從低位（< 35）回升、MACD 出現底背離、股價在支撐位反彈
...
- strategy: 套用的選股策略，只能是「動能策略」、「價值策略」、「突破策略」、「反轉策略」四者之一"""
