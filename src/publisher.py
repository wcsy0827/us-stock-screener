...
<div class="info-grid">
  ...
  <div class="info-card">
    ...
    <div class="pipe-flow">
      ...
      <div class="pipe-step"><span class="pipe-badge">L1</span>硬條件篩選：股價 &gt; $5、30 日均量 &gt; 50 萬、市值 &gt; 3 億；財報防禦牆：排除 5 天內有財報的個股</div>
      <div class="pipe-arrow">↓</div>
      <div class="pipe-step"><span class="pipe-badge">L2</span>技術評分 100 分制，門檻 60 分；恐慌超跌環境（見右側）降至 40 分，RSI &lt; 35 且 20 日跌幅 &gt; 15% 的超賣股強制放行</div>
      <div class="pipe-arrow">↓</div>
      <div class="pipe-step"><span class="pipe-badge">L3</span>DeepSeek AI 依當日大盤環境（Regime）的主推策略精選，最多 5 支；輸入矩陣含 ATR 標準化動能（Momentum_ATR）、量能推進因子（VTF_Score，正值=帶量上攻，負值=高檔出貨）、60 日 Beta 與財報剩餘天數（≤5 天自動排除），跨行業公平評比、避免高 Beta 偏見；陰跌熊市環境下全面防禦，不輸出任何建議（詳見右側 Regime 表）</div>
    </div>
  </div>
